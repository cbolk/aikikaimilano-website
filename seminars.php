...
<!DOCTYPE html>
<head lang="it">
    <title>Aikikai Milano - Stages</title>
    <meta charset="utf-8" />
...
<body>
    ...
    <div id="wrapper">
      ...
      <section id="seminars" class="odd">
		<div class="container">
		  <header>
			<h3 class="cntr">Stages <?php echo $y . "-" . ($y+1); ?></h3>
		  </header>
				...
				for($i = 9; $i <= 12; $i++){
					...
					if($nsem > 0){
						...
						for($isem = 0; $isem < $nsem; $isem++){
							...
							echo "<li class='itemli'><span class='itemhead'>When:</span><span class='itemval'>" .   $from . " <em>-</em> " . $to . "</span></li>";
							echo "<li class='itemli'><span class='itemhead'>Where:</span><span class='itemval'>" . $seminario->shortcity ;
							...
							if($seminario->pdf != NULL)
								echo "pdf <a class='noborder disable' title='download the flyer' href='./seminars/$seminario->pdf'><span class='icon fa-file-pdf-o fa-fw smallicon'></span></a>";
							else
								echo "soon available";
							echo "</li>";
							...
							echo "<li class='itemli'><span class='itemhead'>Type:</span><span class='itemval small'>" .   $seminario->seminartype . "</span>";
							echo "</li>";
							echo "</ul>";
							echo "</div><!--inner-->";
							echo "</article>";
				...
				for($i = 1; $i < 9; $i++){
					...
					if($nsem > 0){
						...
						for($isem = 0; $isem < $nsem; $isem++){
							...
							echo "</li>";
							if($seminario->notes){
								echo "<li class='itemli'><span class='itemhead'>Notes:</span><span class='itemval small'>" .   $seminario->notes . "</span>";
								echo "</li>";
							}
							echo "</ul>";
					...
					<?php
	  	  	  	...
	  	  	  	?>
				<h4 class="cntr">the lst of upcoming stages will soon be available</h4>
	  	  	  	<?php
	  	  	  	}
	  	  	  	?>
     ...
     <section class="color">
			<div class='note calnote smallicon center'>&nbsp;&nbsp;This page is subject to changes and updates. 
