    ...
    $('#expires').datetimepicker({
      ...
      icons: {
        ...
        $("#enddate").on("dp.change", function (e) {
            $('#expires').data("DateTimePicker").date(moment(e.date + 365*60*60*24).format('DD-MM-YYYY'));
        }); 
  });
</script>
                    ...
                    <div class="row"> 
                      <div class="control-group col-md-12" >
                        <label>titolo (max 400 car.) <i class="fa fa-asterisk asterisc"></i></label>
                          <div class="controls">
                              <textarea class="form-control" id='title' name="title" maxlength="400">Seminario di aikido</textarea>
                          </div>
                      </div> 
                  </div>
                  <div class="row"> 
              ...
              ?>        
                    ...
                    <div class="control-group col-xs-6">
                      <label>organizzato da <i class="fa fa-asterisk asterisc"></i></label>
                        <div class="controls">
                          <select class='form-control seminardd' name='organizerfk' id='organizerfk'>
              <?php
...
domenica ore 14:00 - 16:00 lezione</textarea>
            ...
            <div class="control-group col-md-6">
                        <label>note</label>
                        <div class="controls" >
                             <textarea class="form-control" placeholder="Commenti e note" name="notes" id="notes" maxlength="200" rows="3"></textarea>
                         </div>
                      </div> 
        </div>                    
                <hr>
