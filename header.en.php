    ...
    <div id="header">
      <div class="top">	
		...
		<div id="logo">
		  ...
		  <h1 id="title1line">ASD Aikikai Milano - Aikido dojo</h1>
		  <h1 id="title"><span class='asd'>ASD</span> Aikikai Milano</h1>
		  <p id="subtitle"><strong>Aikido dojo</strong></p>
		</div>	
		...
		<td>
		  ...
		  <h4 class="mobile">Aikido dojo</h4>
		  </td>
		<td><img src="assets/img/mon.png" alt="logo" width=48px /></td>
		  ...
		  <ul>
		    <li><a href="./index.en.php#top" id="top-link" class="skel-layers-ignoreHref">
			<span class="icon fa-home">Home</span></a></li>
		    <li><a href="./index.en.php#aikido" id="aikido-link" class="skel-layers-ignoreHref">
			<span class="icon fa-adn">Aikido</span></a></li>
		    <li><a href="./index.en.php#fujimoto" id="fujimoto-link" class="skel-layers-ignoreHref">
			<span class="icon fa-users topsp">Fujimoto Sensei and his school</span></a></li> <!-- e la sua scuola-->
		    <!--li><a href="#insegnanti" id="insegnanti-link" class="skel-layers-ignoreHref">
